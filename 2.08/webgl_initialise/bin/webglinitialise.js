...
Main.gl = null;
Main.main = function() {
	Main.initGL(js.Lib.document.getElementById("hx_webgl_initialise"));
}
Main.initGL = function(canvas) {
	...
	if(Main.gl == null) js.Lib.alert("Could not initialise WebGL, sorry :-("); else js.Lib.alert("WebGL has been initialised!");
}
Main.prototype = {
	__class__: Main
}
