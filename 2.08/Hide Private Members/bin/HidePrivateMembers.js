...
Main.__name__ = ["Main"];
Main.main = function() {
	var sm = new Something();
	sm.sayHello();
	sm.setFoo("BAR!");
	haxe.Log.trace(sm.getFoo(),{ fileName : "Main.hx", lineNumber : 16, className : "Main", methodName : "main"});
}
Main.prototype = {
	__class__: Main
}
var Something = $hxClasses["Something"] = function() {
}
Something.__name__ = ["Something"];
Something.prototype = {
	foo: null
	,sayHello: function() {
		return "hello!";
	...
	,__class__: Something
	,__properties__: {set_foo:"setFoo",get_foo:"getFoo"}
}
var haxe = haxe || {}
